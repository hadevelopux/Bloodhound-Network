...
# ==============================================================================
# SCRIPT DE APROVISIONAMIENTO AUTOMÁTICO BARE-METAL - MODO SENSOR (32-BIT)
# AUTO-PROVISIONING BARE-METAL SCRIPT - SENSOR MODE (32-BIT)
# ==============================================================================
...
# Añadir al usuario actual al grupo docker para evitar el uso constante de sudo (Clave en 32-bit y 64-bit)
if [ -n "$SUDO_USER" ]; then
